...
/**
 * @fn void  CompositeInput::Register(IEvent &Evtnotification)
 * @brief This API is used to register the Events
 *
 * @return unint32_t
 */
uint32_t CompositeInput::Register(IEvent &Evtnotification) 
{
  return 0;
}
 ...
 * @return unint32_t
 */
uint32_t CompositeInput::UnRegister(IEvent &Evtnotification) 
{
  return 0;
}
