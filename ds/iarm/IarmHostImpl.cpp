...
IarmHostImpl::CallbackList<IAudioOutputPortEvents*, IARMGroupAudioOutputPort> IarmHostImpl::s_audioOutputLisListeners;
...
IarmHostImpl::~IarmHostImpl()
{
    ...
    s_audioOutputLisListeners.Release();
}
